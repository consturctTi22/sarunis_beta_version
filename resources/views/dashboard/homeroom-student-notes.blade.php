...
@section('content')
    <div class="portal-dashboard-shell portal-directory-shell" data-notes-page data-endpoint="{{ url('/walikelas/catatan') }}">
            ...
            <div class="portal-directory-stack">
                <section class="portal-panel portal-directory-banner">
                    ...
                    <div class="portal-directory-banner__copy">
                        <h1>Catatan Siswa</h1>
                        <p>Kelola catatan dan tindak lanjut siswa kelas perwalian.</p>
                    </div>
    ...
    @include('dashboard.partials.student-notes-modal', ['students' => $students, 'teachers' => collect([$teacher])->filter(), 'showTeacherField' => false])
@endsection
