    ...
    <div class="portal-dashboard-shell">
        @include('dashboard.partials.sidebar', ['menuSections' => [
            ['title' => 'Menu Utama', 'items' => [
                ['label' => 'Dashboard', 'url' => url('/guru-piket/dashboard'), 'icon' => 'home'],
                ['label' => 'Data Pelanggaran', 'url' => url('/guru-piket/pelanggaran'), 'icon' => 'report']
            ]]
        ...
        <main class="portal-dashboard-main">
            <div class="portal-directory-header">
                <div>
                    ...
                    <p>Selamat datang, {{ $user->name }}. Catat pelanggaran siswa yang terjadi hari ini di sini.</p>
                </div>
            </div>
            ...
            <section class="portal-panel mt-4">
                ...
                <a href="{{ url('/guru-piket/pelanggaran') }}" class="btn btn-primary mt-3">Kelola Pelanggaran</a>
            </section>
        </main>
    </div>
@endsection
